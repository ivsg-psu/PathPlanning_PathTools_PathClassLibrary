function cleaned = fcn_cleanGPSData(d)
...
unwrapped_yaw = fcn_unwrapAngles(raw_yaw);
...
dezeroed_yaw = fcn_replaceBadIndicesWithNearestGood(unwrapped_yaw,good_indices);
...
kinematic_yaw = fcn_enforceKinematicYawLimits(dezeroed_yaw,t, U,U_limit);
...
nonstationary_yaw = fcn_replaceBadIndicesWithNearestGood(raw_yaw,good_indices);
...
unwrapped_yaw = fcn_unwrapAngles(nonstationary_yaw);
...
kinematic_yaw = fcn_enforceKinematicYawLimits(unwrapped_yaw,t, U,U_limit);
kinematic_yaw = fcn_unwrapAngles(kinematic_yaw);
...
%%
function cleaned = fcn_medianFilterData(data,sigmas) %#ok<DEFNU>
...
%%
function new_data = fcn_replaceBadIndicesWithNearestGood(data,good_indices)
...
%% 
function kinematic_yaw = fcn_enforceKinematicYawLimits(yaw,t, U,U_limit)
