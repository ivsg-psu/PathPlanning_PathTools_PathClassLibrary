...
Results = fcn_DataClean_mergeByTakingBayesianAverageOfSignals(timeFilteredData,[{'GPS_Novatel'},{'GPS_Hemisphere'}],[{'Yaw_deg','Yaw_deg_from_position'},{'Yaw_deg_from_velocity'}],'GPS_Novatel','Yaw_deg');
mergedData.MergedGPS.Yaw_deg       = Results.Center;
mergedData.MergedGPS.Yaw_deg_Sigma = Results.Sigma;

% Fill in YawRate information
Results = fcn_DataClean_mergeByTakingBayesianAverageOfSignals(timeFilteredData,[{'IMU_ADIS'},{'IMU_Novatel'}],{'ZGyro'},'IMU_Novatel','ZGyro');
mergedData.MergedIMU.ZGyro       = Results.Center;
mergedData.MergedIMU.ZGyro_Sigma = Results.Sigma;

% Fill in Velocity information
Results = fcn_DataClean_mergeByTakingBayesianAverageOfSignals(timeFilteredData,[{'GPS_Novatel'},{'Encoder_RearWheels'}],{'velMagnitude'},'GPS_Novatel', 'velMagnitude');
...
Results = fcn_DataClean_mergeByTakingBayesianAverageOfSignals(timeFilteredData,[{'GPS_Novatel'},{'GPS_Hemisphere'},{'VelocityProjectedByYaw'}],[{'xEast_increments'}],'GPS_Novatel','xEast_increments'); %#ok<NBRAK>
mergedData.MergedGPS.xEast_increments       = Results.Center;
mergedData.MergedGPS.xEast_increments_Sigma = Results.Sigma;

Results = fcn_DataClean_mergeByTakingBayesianAverageOfSignals(timeFilteredData,[{'GPS_Novatel'},{'GPS_Hemisphere'},{'VelocityProjectedByYaw'}],[{'yNorth_increments'}],'GPS_Novatel','yNorth_increments'); %#ok<NBRAK>
...
Results = fcn_DataClean_mergeByTakingBayesianAverageOfSignals(timeFilteredData,[{'GPS_Novatel'},{'GPS_Hemisphere'}],[{'xEast'}],'GPS_Novatel','xEast'); %#ok<NBRAK>
mergedData.MergedGPS.xEast       = Results.Center;
mergedData.MergedGPS.xEast_Sigma = Results.Sigma;

Results = fcn_DataClean_mergeByTakingBayesianAverageOfSignals(timeFilteredData,[{'GPS_Novatel'},{'GPS_Hemisphere'}],[{'yNorth'}],'GPS_Novatel','yNorth'); %#ok<NBRAK>
mergedData.MergedGPS.yNorth       = Results.Center;
mergedData.MergedGPS.yNorth_Sigma = Results.Sigma;

Results = fcn_DataClean_mergeByTakingBayesianAverageOfSignals(timeFilteredData,[{'GPS_Novatel'},{'GPS_Hemisphere'}],[{'zUp'}],'GPS_Novatel','zUp'); %#ok<NBRAK>
