function path_average_final = fcn_Path_findAveragePath(data,reference_traversal, varargin)
...
%
%      path_average_final = ...
%      fcn_Path_findAveragePath(data,reference_traversal,(flag_calculate_reference_traversal),(num_iterations))
%
% INPUTS:
%
