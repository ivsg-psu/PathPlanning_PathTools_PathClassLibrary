...
MATLABFLAG_PATH_FLAG_WARN_FINDCLOSESTPOINTS = getenv("MATLABFLAG_PATH_FLAG_WARN_FINDCLOSESTPOINTS");

if isempty(MATLABFLAG_PATH_FLAG_WARN_FINDCLOSESTPOINTS)

    warning('on','backtrace');
    warning('The function fcn_Path_findClosestPointsToTraversal is being deprecated. Please use fcn_Path_findClosestPointsToPath instead.');


    setenv('MATLABFLAG_PATH_FLAG_WARN_FINDCLOSESTPOINTS','1');
end
