...
MATLABFLAG_PATH_FLAG_WARN_FILLOFFSETTRAVERSALSABOUT = getenv("MATLABFLAG_PATH_FLAG_WARN_FILLOFFSETTRAVERSALSABOUT");

if isempty(MATLABFLAG_PATH_FLAG_WARN_FILLOFFSETTRAVERSALSABOUT)

    warning('on','backtrace');
    warning(['The function fcn_Path_fillOffsetTraversalsAboutTraversal is being deprecated. ' ...
        'Please use fcn_Path_fillOffsetPathsAboutPath instead.']);


    setenv('MATLABFLAG_PATH_FLAG_WARN_FILLOFFSETTRAVERSALSABOUT','1');
end
...
if flag_do_plots
    ...
    fcn_Path_plotTraversalsXY(offset_traversals,figNum);
