...
%     from_traversal,to_traversal,(flag_rounding_type),(search_radius),(figNum))
...
%% Basic demonstration of fcn_Path_findCenterlineVoteFromTraversalToTraversal
figNum = 10001;
titleString = sprintf('Finds the center projected from one traversal toward another');
...
[centerline_points_projected,unit_vectors_orthogonal] = ...
    fcn_Path_findCenterlineVoteFromTraversalToTraversal(...
    from_traversal,to_traversal,(flag_rounding_type),(search_radius),(flag_project_full_distance), (figNum));
...
Nfrom = length(from_traversal.X(:,1));
...
[centerline_points_projected,unit_vectors_orthogonal] = ...
    fcn_Path_findCenterlineVoteFromTraversalToTraversal(...
    from_traversal,to_traversal,(flag_rounding_type),(search_radius),(flag_project_full_distance), ([]));
...
[centerline_points_projected,unit_vectors_orthogonal] = ...
    fcn_Path_findCenterlineVoteFromTraversalToTraversal(...
    from_traversal,to_traversal,(flag_rounding_type),(search_radius),(flag_project_full_distance), (-1));
