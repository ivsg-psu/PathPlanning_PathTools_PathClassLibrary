...
MATLABFLAG_PATH_FLAG_WARN_CONVERTTRAVERSALXYTOSY = getenv("MATLABFLAG_PATH_FLAG_WARN_CONVERTTRAVERSALXYTOSY");

if isempty(MATLABFLAG_PATH_FLAG_WARN_CONVERTTRAVERSALXYTOSY)

    warning('on','backtrace');
    warning(['The function fcn_Path_convertTraversalXYtoSy is being deprecated. ' ...
        'Please use fcn_Path_convertXY2St instead.']);


    setenv('MATLABFLAG_PATH_FLAG_WARN_CONVERTTRAVERSALXYTOSY','1');
end
