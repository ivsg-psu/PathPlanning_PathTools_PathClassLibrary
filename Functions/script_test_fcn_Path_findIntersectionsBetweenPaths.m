% script_test_fcn_Path_findIntersectionsBetweenPaths.m
% This is a script to exercise the function: fcn_Path_findIntersectionsBetweenPaths
...
% Create a dummy path and convert it to path_2
path_2 = [5 -5; 5 5];
...
% Create a dummy path and convert it to path_2
path_2 = [1 1; 2 0.5; 4 1; 5 3; 6 1.5; 7 1.75; 9 1];
...
% Create a dummy path and convert it to path_1
path_1 = [1 1; 2 0.5; 4 1; 5 3; 6 1.5; 7 1.75; 9 1];
...
% Create a dummy path and convert it to path_2
path_2 = [1 1; 2 0.5; 4 1; 5 3; 6 1.5; 7 1.75; 9 1; 10 0];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%§
function print_results(intersection_points,s_coordinates_in_path_1,s_coordinates_in_path_2)
if 1==0
    N_chars = 25;
    ...
    if ~isempty(intersection_points)
        for ith_intersection =1:length(intersection_points(:,1))
            ...
            results_4_str = sprintf('%.2f',s_coordinates_in_path_1(ith_intersection));
            fixed_results_4_str = fcn_DebugTools_debugPrintStringToNCharacters(results_4_str,N_chars);
            results_5_str = sprintf('%.2f',s_coordinates_in_path_2(ith_intersection));
            ...
            %             s_coordinates_in_path_1(ith_intersection),...
            %             s_coordinates_in_path_2(ith_intersection));
