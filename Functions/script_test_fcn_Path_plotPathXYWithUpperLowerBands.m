% script_test_fcn_Path_plotPathXYWithUpperLowerBands
% Tests fcn_Path_plotPathXYWithUpperLowerBands
...
fcn_Path_plotPathXYWithUpperLowerBands( middle_path, upper_path, lower_path, (fig_num));
