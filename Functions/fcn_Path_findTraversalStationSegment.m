...
MATLABFLAG_PATH_FLAG_WARN_FINDTRAVERSALSTATION = getenv("MATLABFLAG_PATH_FLAG_WARN_FINDTRAVERSALSTATION");

if isempty(MATLABFLAG_PATH_FLAG_WARN_FINDTRAVERSALSTATION)

    warning('on','backtrace');
    warning(['The function fcn_Path_findTraversalStationSegment is being deprecated. ' ...
        'Please use fcn_Path_findPathStationSegment instead.']);


    setenv('MATLABFLAG_PATH_FLAG_WARN_FINDTRAVERSALSTATION','1');
end
