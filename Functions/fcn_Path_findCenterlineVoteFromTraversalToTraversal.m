...
MATLABFLAG_PATH_FLAG_WARN_FINDCENTERLINEVOTE = getenv("MATLABFLAG_PATH_FLAG_WARN_FINDCENTERLINEVOTE");

if isempty(MATLABFLAG_PATH_FLAG_WARN_FINDCENTERLINEVOTE)

    warning('on','backtrace');
    warning(['The function fcn_Path_findCenterlineVoteFromTraversalToTraversal is being deprecated. ' ...
        'Please use fcn_Path_findCenterlineVoteFromPathToPath instead.']);


    setenv('MATLABFLAG_PATH_FLAG_WARN_FINDCENTERLINEVOTE','1');
end
