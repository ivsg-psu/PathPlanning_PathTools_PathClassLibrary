% script_test_fcn_Path_findClosestPointsToPath.m
% This is a script to exercise the function: fcn_Path_findClosestPointsToPath.m
...
% reference_path,cellArrayOfPaths,flag_yaw,flag_3D)
...
cellArrayOfPaths{1} = nearby_path;
flag_yaw = 0;
flag_3D = 0;
...
NreferenceTraversal = length(central_path(:,1));
...
% Fill in some dummy cellArrayOfPaths
paths_array = fcn_Path_fillSamplePaths;

% Convert paths to traversal structures
Ntraversals = 3;
clear cellArrayOfPaths
cellArrayOfPaths = cell(3,1);
for i_Path = 1:Ntraversals
    cellArrayOfPaths{i_Path,1} = paths_array{i_Path};
end
...
% Calculate the closest point and distance on the nearby path
[closestXs,closestYs,closestZs,closestYaws] = ...
    fcn_Path_findClosestPointsToPath(central_path,cellArrayOfPaths,flag_yaw,flag_3D,([]));
...
% Calculate the closest point and distance on the nearby path
[closestXs,closestYs,closestZs,closestYaws] = ...
    fcn_Path_findClosestPointsToPath(central_path,cellArrayOfPaths,flag_yaw,flag_3D,(-1));
