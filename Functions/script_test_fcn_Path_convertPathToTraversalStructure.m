...
traversal = fcn_Path_convertPathToTraversalStructure(path_simple_2D, (figNum));
...
traversal = fcn_Path_convertPathToTraversalStructure(path_simple_3D,figNum);
...
for i_traveral = 1:length(paths_array)
    traversal = fcn_Path_convertPathToTraversalStructure(paths_array{i_traveral},figNum);
...
fcn_Path_plotTraversalsXY(data,figNum*10);
xlabel('X [m]');
ylabel('Y [m]');
