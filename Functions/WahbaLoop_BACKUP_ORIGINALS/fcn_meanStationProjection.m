function [aligned_Data_ByStation,mean_Data] = fcn_meanStationProjection(lapData,numLaps,RouteStructure)
...
grid on; 
xlabel('mean_xEast [m]') %set  x label 
ylabel('mean_yNorth [m]') % set y label 
