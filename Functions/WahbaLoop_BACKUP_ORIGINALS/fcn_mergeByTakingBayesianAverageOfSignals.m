function Merged = fcn_mergeByTakingBayesianAverageOfSignals(d,sensors_list,field_names,truth_sensor,truth_field)
...
[C, C_sigma] = fcn_bayesianAverageMatrixForm(data_columns,sigma_columns);
