function rawData = fcn_DataClean_loadRawData(filename,variable_names)
...
fcn_DataClean_checkConsistency(rawData);
...
function fcn_DataClean_checkConsistency(rawData)
