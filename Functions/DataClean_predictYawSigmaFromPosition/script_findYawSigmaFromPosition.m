% This is a script to simulate the variance to expect from a position-based
% estimate of GPS with 0.01 1-sigma error. The results show a curve fit of
% the expected variance, in degrees, for a given spacing between adjacent
% points.
close all
clear all
clc
...
[predicted_sigmaDeg] = fcn_DataClean_predictYawSigmaFromPosition(distances);
