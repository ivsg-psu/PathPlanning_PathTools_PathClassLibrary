% script_test_fcn_Path_findClosestPointsFromPath.m
% This is a script to exercise the function: fcn_Path_findClosestPointsFromPath.m
...
% function [closestXs,closestYs,closestZs,closestYaws] = fcn_Path_findClosestPointsFromPath(reference_traversal,data,flag_yaw,flag_3D) %#ok<*INUSD>
...
[closestXs,closestYs,closestZs] = ...
    fcn_Path_findClosestPointsFromPath(central_traversal,data,flag_yaw,flag_3D,fig_num);
