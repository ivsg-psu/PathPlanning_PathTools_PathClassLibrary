...
%      place
%
%      reference_traversal: a traversal structure that specifies the path
%      where projections to other paths are taking place.
%
%      all_traversals: a data structure containing a cell array of
%      traversal structures that specifies the paths
%      where intersections from the reference_traversal would hit.
%
%      (OPTIONAL INPUTS)
...
%
%      search_radius: how far in station distance for the search points to look (default is
%      3 times the differences in station lengths within all_traversals )
%
...
% EXAMPLES:
%
% See the script: script_test_fcn_Path_FindOrthogonalScatterFromPathToPaths
...
if flag_do_plot
    ...
    % legend('Reference traversal','Paths to check','Station query vectors','Hit locations');
