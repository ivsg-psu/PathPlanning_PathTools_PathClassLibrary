...
[aligned_Data_ByStation,mean_Data] = ...
    fcn_Path_findAveragePathViaStationAlignment(data);
...
path_average_final2 = fcn_Path_findAveragePathViaClosestPoint(data);
...
path_average_final3 = fcn_Path_findAveragePathViaOrthogonalProjection(data);
...
[path_average_final4, closestXs, closestYs, closestDistances]  = ...
    fcn_Path_findAveragePathViaOrthogonalProjection(data);
...
fcn_Path_plotPathXYWithVarianceBands(path_average_final4,...
