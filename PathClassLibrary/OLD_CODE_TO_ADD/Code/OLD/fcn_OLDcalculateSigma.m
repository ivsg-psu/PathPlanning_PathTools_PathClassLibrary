function sigma = fcn_calculateSigma(aligned_Data_ByStation,mean_Data,numLaps)
% function [lateral_offset,lateral_offset_direction,lateral_offset_magnitude,sigma] = fcn_lateralOffsetAndSigma(aligned_Data_ByStation,mean_Data,numLaps)
