% This is an example of how to write a wrapper script to run and log all the
% scripts in a directory taken from the wrapper that runs all test scripts
% in the MapGen class library for the purpose of evaluating every assertion test
% in these files
