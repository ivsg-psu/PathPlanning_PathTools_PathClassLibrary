...
%% Tool to change all variables everywhere
% fcn_DebugTools_replaceStringInDirectory(fullfile(pwd), cat(2,'_PATH','CLASS_'), '_PATH_','Path');
% fcn_DebugTools_replaceStringInDirectory(fullfile(pwd,'Functions'), cat(2,'_PATH','CLASS_'), '_PATH_','Path');
...
setenv('MATLABFLAG_PATH_FLAG_CHECK_INPUTS','1');
setenv('MATLABFLAG_PATH_FLAG_DO_DEBUG','0');
...
test_traversal.traversal{1} = fcn_Path_convertPathToTraversalStructure(test_path{1});
